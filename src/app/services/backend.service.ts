...
import { fakeData, fakeSoilMoisture, fakePhosphorus, fakeNitrogen, fakeHumidity, fakeRoomTemperature } from '../models/fake-database/fake-data';
...
export class BackendService {
  ...
  getRoomTemperatureData(): Observable<Measurement> {
    return of(fakeRoomTemperature).pipe(catchError(this.handleError<Measurement>("getRoomTemperatureData")));
  }
